// arguments.c procesa los argumentos de línea de comandos para un servidor FTP simple.
// Permite especificar el puerto y la dirección IP, validando que el puerto sea adecuado
// y que la dirección IP sea una interfaz local válida. Si el puerto es 21, requiere privilegios de root.
